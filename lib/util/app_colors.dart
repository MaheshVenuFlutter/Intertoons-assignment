...
class AppColors {
  ...
  static const Color mainColor = Color.fromARGB(255, 59, 233, 213);
  ...
  static const Color buttonBackgroundColor = Color.fromARGB(255, 221, 220, 219);
  ...
  static const Color yelowColor = Color(0xFFcccd379);
}
